...
boundaries. Comments, displayed mathematics, tables, verbatim content, and
other protected regions are not reflowed. Reflow is disabled when wrapping is
disabled.
...
\begin{table}[H]
  \begin{center}
    \begin{tabular}{|l|l|l|l|}
      ...
      \texttt{"minimal"} & Paragraph reflow strategy; \\
                            & & & also accepts \texttt{"canonical"} \\
